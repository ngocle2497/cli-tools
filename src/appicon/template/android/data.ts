...
// Icon size
const BASE_LINE_FORCE_GROUND_ICON_SIZE =
  BASE_LINE_FORCE_GROUND_COVER_SIZE - PADDING_FORCE_GROUND_BASE_LINE * 2;

const BASE_LINE_SQUARE_ICON_SIZE =
  BASE_LINE_COVER_SIZE - PADDING_SQUARE_BASE_LINE * 2;
const BASE_LINE_SQUARE_ICON_RADIUS = BASE_LINE_SQUARE_ICON_SIZE * 0.0833;

const BASE_LINE_CIRCLE_ICON_SIZE =
  BASE_LINE_COVER_SIZE - PADDING_CIRCLE_BASE_LINE * 2;
